<template>
  <v-container fluid class="bg">
    <v-layout row justify-center fill-height class="" align-center>
      <v-flex xs12 md10 sm10 lg10>
        <h1>projects</h1>
        <h2>Timadoos prestige limited security consultants have consulted to dozens of businesses involving hundreds of commercial and industrial properties.</h2>
